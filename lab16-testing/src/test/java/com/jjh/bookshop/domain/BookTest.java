...
class BookTest {
    ...
    private static final Author author = new Author("Pete Smith", authorAddress, "Technical");

    private static final Address publisherAddress = new Address(1, "Main Street", "Some City", "Kent", "KA1 43A");
    private static final Publisher publisher = new Publisher("Bill Smith", publisherAddress, "Tech Books Publishing Ltd.");
